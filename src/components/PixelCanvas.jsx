 ...
 * Vanilla-JS port (no framework deps) of the original "pixel-canvas" effect.
 * -------------------------------------------------------------------------- */
...
export default function PixelCanvas({ colors, gap = 5, speed = 30, playing }) {
  ...
  useEffect(() => {
    ...
    // Hover is tracked on the parent cell, not the canvas, so the canvas
    // never blocks pointer events on the content above it.
